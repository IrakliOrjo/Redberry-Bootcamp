  ...
  return (
    <div className="">
      ...
      object-cover pt-[1.5625em] justify-center items-center' >
        ...
        <div className='absolute top-[89px] w-[91%]  mx-auto  h-[2px] bg-[#1A1A1A]'></div>
        
        <div className='absolute w-[299px] h-[299px] bg-[url("./images/LOGO-401.png")] top-[19.5625em] left-[56.25em] mix-blend-multiply z-0'>
